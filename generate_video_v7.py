#!/usr/bin/env python3
"""
Buckit - Brain's External RAM  ·  Promo Video Generator v7
───────────────────────────────────────────────────────────
  • 2-scene dialogue: user <-> buckit conversation
  • Scene 1: Dark navy bg / light blue text (problem)
  • Scene 2: Dark green bg / bright green text (v2 green, solution)
...
SCENE1_BG          = (15, 20, 55)
SCENE1_USER_TEXT   = (140, 200, 255)     # light blue for user
SCENE1_USER_PROMPT = (70, 100, 180)      # mid blue prompt
...
SCENE1_RAM_DIM     = (60, 50, 90)        # dim bar background

# -- Scene 2: Dark green terminal (v2 green, the solution) --
SCENE2_BG          = (12, 38, 28)
SCENE2_USER_TEXT   = (0, 255, 140)       # bright green for user
SCENE2_USER_PROMPT = (0, 140, 75)        # dim green prompt
SCENE2_BOT_TEXT    = (255, 220, 80)      # warm yellow for buckit
SCENE2_BOT_PROMPT  = (180, 150, 50)      # dim yellow prompt
...
def main():
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    print("=" * 52)
    print("  Buckit - Brain's External RAM  |  Promo v7")
    print("=" * 52)
    results = []
